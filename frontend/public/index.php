                        ...
                        <div class="tab-pane fade <?= $i == 0 ? 'show active' : '' ?>"
                            ...
                            <div class="row g-3">
                                ...
                                $query_produk = mysqli_query($koneksi,
                                    "SELECT *,
                                     (SELECT AVG(rating) FROM product_reviews WHERE id_product = products.id_product) AS avg_rating,
                                                ...
                                                <div class="p-3 d-flex flex-column flex-grow-1 justify-content-between bg-white">
                                                    <div>
                                                        ...
                                                        <div class="small mb-1">
                                                            <?php if ((int) $produk['review_count'] > 0): ?>
                                                                <span style="color:#f8b400;">★</span> <?= round((float) $produk['avg_rating'], 1) ?> <span class="text-muted">(<?= (int) $produk['review_count'] ?>)</span>
                                                            <?php else: ?>
